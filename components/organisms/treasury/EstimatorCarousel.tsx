...
import { LootSaleEstimatorCard } from "@/components/organisms/loot/LootSaleEstimatorCard";
import { ContentRewardEstimatorCard } from "@/components/organisms/treasury/ContentRewardEstimatorCard";

export function EstimatorCarousel({
  myPoints,
  totalPoints,
  myPower,
  totalPower,
