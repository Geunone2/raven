...
import type { ContentParticipationStats } from "@/lib/actions/schedule/scheduleCheckins";
...
import { MemberBankOverviewCard } from "@/components/organisms/treasury/MemberBankOverviewCard";
import { MyBankSummaryCard } from "@/components/organisms/treasury/MyBankSummaryCard";
import { EstimatorCarousel } from "@/components/organisms/treasury/EstimatorCarousel";
    ...
    <div className="space-y-6">
      ...
      {view === "all" ? (
        <div className="space-y-8">
          <TreasurySummaryCard balance={treasuryBalance} transactions={treasuryTransactions} />
